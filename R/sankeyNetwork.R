...
sankeyNetwork <- function(
    ...
    stage_names = NULL,
    pinToTopCore = FALSE,
    rescaleCoreNodes = FALSE,
    coreNodeNames = c("Precipitation", "Green Water", "Evaporation & Return"),
    cropStage = 2L,
    evapLinkPx = 25,
...

{
    ...
    options = list(NodeID = NodeID, NodeGroup = NodeGroup, LinkGroup = LinkGroup,
        ...
        pinToTopCore = pinToTopCore,
        zoomable_nodes = zoomable_nodes, stage_names = stage_names,
        rescaleCoreNodes = rescaleCoreNodes,
...
#'
#' Output and render functions for using WaterSankeyD3 within Shiny applications.
#'
#' @param outputId output variable to read from
#' @param width,height dimensions of the widget
#' @param expr expression to render
#' @param env environment
#' @param quoted logical, is expr quoted
#'
#' @name WaterSankeyD3-shiny
NULL

#' @rdname WaterSankeyD3-shiny
#' @export
